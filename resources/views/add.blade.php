    ...
    <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
        <div class="form-group mb-3">
          <label>Nama*</label>
          <input name="nama_user" type="text" class="form-control" placeholder="Masukkan nama" value="">
        ...
        <div class="form-group mb-3">
          <label>No Hp</label>
          <input name="nohp" type="number" class="form-control" placeholder="Masukkan No Handphone" value="">
        </div>
        <div class="form-group mb-3">
          <label>Alamat*</label>
